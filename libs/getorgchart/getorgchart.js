...
getOrgChart.prototype._as = function() {
	this._f();
	var a = getOrgChart.INNER_HTML.replace("[theme]", this.config.theme).replace("[color]", this.config.color).replace(/\[height]/g, this._aO).replace(/\[toolbar-height]/g, this.theme.toolbarHeight);
...
getOrgChart.prototype._f = function() {
	this._zB = get._c().msie ? this.element.clientWidth : window.getComputedStyle(this.element, null).width;
	this._zB = parseInt(this._zB);
	if (this._zB < 3) {
		this._zB = 1024;
		this.element.style.width = "1024px"
	}
	this._zG = get._c().msie ? this.element.clientHeight : window.getComputedStyle(this.element, null).height;
...
getOrgChart.prototype._z = function(a) {
	...
	for (var d in this.nodes) {
		...
		if (this.nodes[d]._zH == this.nodes[d].x && this.nodes[d]._zN == this.nodes[d].y) {
			continue
		}
...
getOrgChart.INNER_HTML = '<div class="get-[theme] get-[color] get-org-chart"><div class="get-oc-tb"><div><div style="height:50px;background-color:#F6F6F6;"><input placeholder="Search" type="text" class="form-control" /><a title="previous" class="get-prev get-disabled" href="javascript:void(0)">&nbsp;</a><a title="next" class="get-next get-disabled" href="javascript:void(0)">&nbsp;</a><a class="get-minus" title="zoom out" href="javascript:void(0)">&nbsp;</a><a class="get-plus" title="zoom in" href="javascript:void(0)">&nbsp;</a><a href="javascript:void(0)" class="get-grid-view" title="grid view">&nbsp;</a><a href="javascript:void(0)" class="get-print" title="print">&nbsp;</a></div><div style="height:[toolbar-height]px;"><a title="previous page" class="get-prev-page" href="javascript:void(0)">&nbsp;</a></div><div style="height:[toolbar-height]px;"><a title="previous page" class="get-prev-page" href="javascript:void(0)">&nbsp;</a></div></div></div><div class="get-oc-c" style="height:[height]px;"></div><div class="get-oc-v" style="height:[height]px;"><div class="get-image-pane"></div><div class="get-data-pane"></div></div><div class="get-oc-g" style="height:[height]px;"></div><div class="get-left"><img src="img/structure/arrows/arrow_left.png" ></div><div class="get-right"><img src="img/structure/arrows/arrow_right.png" ></div><div class="get-up"><img src="img/structure/arrows/arrow_up.png" ></div><div class="get-down"><img src="img/structure/arrows/arrow_down.png" ></div></div>';
...
getOrgChart._w = function(t, m, g) {
	...
	for (var d = t.config.maxDepth - g; a != null && b != null && c <= d;) {
		...
		var s = (b._a8 + h + t._P(b) + t.config.subtreeSeparation) - (a._a8 + i);
		if (s > 0) {
			var q = m;
			var n = 0;
...
getOrgChart._zm = function(h, d, b, i, k) {
	if (b <= h.config.maxDepth) {
		...
		if (d._Y() != 0) {
			getOrgChart._zm(h, d._I(), b + 1, i + d._ao, k + c + h.config.levelSeparation)
		}
		var f = d._2();
		if (f != null) {
...
getOrgChart.node.prototype.draw = function(a) {
	...
	h.push(getOrgChart.OPEN_NODE.replace("[data-node-id]", this.id).replace("[x]", this._zH == null ? this.x : this._zH).replace("[y]", this._zN == null ? this.y : this._zN).replace("[level]", this.level).replace("[nodeCssClass]", d));
...
getOrgChart.prototype.showMainView = function() {
	...
	this._X._7.style.left = "-9999px";
	this._X._7.innerHTML = "";
	if (this._X._zD.style.top != 0 && this._X._zD.style.top != "" && this._X._zD.style.top != "0px") {
		get._z(this._X._zD, {
			top: -46
		}, {
			top: 0
...
getOrgChart.prototype._ap = function(g, b) {
	...
	if (this._aK.dragStart) {
		...
		var c = j[3] / this._aO;
		var a = k > c ? k : c;
		j[0] = -((e - this._aK.dragStart.x) * a) + this._aK.dragStart.viewBoxLeft;
		j[1] = -((f - this._aK.dragStart.y) * a) + this._aK.dragStart.viewBoxTop;
		j[0] = parseInt(j[0]);
		j[1] = parseInt(j[1]);
...
getOrgChart.prototype._l = function() {
	if ((this._zh.currentIndex < this._zh.found.length - 1) && (this._zh.found.length != 0)) {
...
getOrgChart.prototype.loadFromJSON = function(g, p, a) {
	...
	if (this.config.layout == getOrgChart.MIXED_HIERARCHY_RIGHT_LINKS) {
		for (var e in this.nodes) {
			...
			if (k.children.length == 0 && n && typeof n.children == 'object' ) {
...
getOrgChart.prototype._b = function(j, d) {
	...
	if (d[0].touches.length == 1) {
		...
		if (this._aK.dragStart) {
			...
			var f = l[3] / this._aO;
			var a = m > f ? m : f;
			l[0] = -((g - this._aK.dragStart.x) * a) + this._aK.dragStart.viewBoxLeft;
			l[1] = -((h - this._aK.dragStart.y) * a) + this._aK.dragStart.viewBoxTop;
			l[0] = parseInt(l[0]);
			l[1] = parseInt(l[1]);
